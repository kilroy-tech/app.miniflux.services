/**
 * miniflux.services/config/delete_template.js - preflight/postflight functions for miniflux.services/config/delete_template
 * @module miniflux.services/config/delete_template
 * @file miniflux.services/config/delete_template preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2024, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:miniflux.services/config/delete_template";
