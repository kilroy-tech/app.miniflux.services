/**
 * miniflux.services/config/delete_chat_agent.js - preflight/postflight functions for miniflux.services/config/delete_chat_agent
 * @module miniflux.services/config/delete_chat_agent
 * @file miniflux.services/config/delete_chat_agent preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2025, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:miniflux.services/config/delete_chat_agent";
