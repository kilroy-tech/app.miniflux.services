/**
 * miniflux.services/chat_agent/resume_hook.js - preflight/postflight functions for miniflux.services/chat_agent/resume_hook
 * @module miniflux.services/chat_agent/resume_hook
 * @file miniflux.services/chat_agent/resume_hook preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2024, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:miniflux.services/chat_agent/resume_hook";
...
function _processMessage (ctx, bot) {
    ...
    return res.then (x => {
        return request (options).then ((body)=>{
            ...
            console.log (`Miniflux Bot sent message: ${text}`);
...
function postflight(authData, wfProxy) {
    ...
    try {
        ...
        if (global.REBAR_NAMESPACE.__Miniflux == undefined) {
            global.REBAR_NAMESPACE.__Miniflux = {};
        }
        ...
        global.REBAR_NAMESPACE.__Miniflux [ta_alias] = new_bot;
