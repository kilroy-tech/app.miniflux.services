/**
 * miniflux.services/config/swarm_noop.js - preflight/postflight functions for miniflux.services/config/swarm_noop
 * @module miniflux.services/config/swarm_noop
 * @file miniflux.services/config/swarm_noop preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2025, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:miniflux.services/config/swarm_noop";
